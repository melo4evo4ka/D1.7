resource "null_resource" "docker-swarm-manager" {
  ...
  provisioner "file" {
    source      = "/Users/mingazovairat/terraform_HW-03/microservices-demo-user-contribs/deploy/docker-compose/docker-compose-v3.yml"
...
resource "null_resource" "docker-swarm-worker" {
  ...
  provisioner "file" {
    source      = "/Users/mingazovairat/terraform_HW-03/microservices-demo-user-contribs/deploy/docker-swarm/infra/yandex/join.sh"
